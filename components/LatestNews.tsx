...
const nepalCarNews = [
  ...
  },
  {
    ...
    title:
      "First Drive: Is the new Suzuki Fronx the perfect city SUV for Kathmandu?",
  },
  {
    image: "/news/vehicle-tax-revision.jpg",
    slug: "blogs/tax-revisions",
    title:
      "Understanding the Latest Vehicle Tax Revisions in Nepal for 2081/82",
  },
];

const LatestNews = () => {
  return (
    <div className="w-full mx-auto p-4 md:px-6 lg:px-8 pb-10 bg-[#F3F4F6]">
      <div className="max-w-screen-xl mx-auto">
        <h2 className="text-2xl text-center md:text-3xl font-bold mb-10 text-[#00594F]">
          Latest Updates
        </h2>
