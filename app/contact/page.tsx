...
const ContactUs = () => {
  return (
    <div className="bg-gray-50  w-full max-w-screen-2xl mx-auto ">
      {/* Hero Section with Background Image */}
      <div 
        className="relative bg-cover  bg-center h-72 md:h-96" 
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1634981297356-f9b4daa98a92?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGNvbnRhY3QlMjB1cyUyMHBhZ2UlMjB3aXRoJTIwY2FyJTIwb2ZmaWNlfGVufDB8fDB8fHww')" }}
      >
                ...
                <dl className="mt-10 space-y-8">
                    ...
                    <div className="flex items-start">
                        ...
                        <dd className="ml-3 text-base text-gray-600">
                            ...
                            <span>+977-9872354607 / +977-9854673462</span>
                        </dd>
                    </div>
                    {/* Email */}
                    <div className="flex items-start">
